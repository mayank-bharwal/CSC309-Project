...
const RegularDashboard = ({ user }) => {
  const actions = [
    {
      title: "Your Points",
      path: "/regular/points",
      description: "View your current point balance",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            d="M12 8c-1.105 0-2 .672-2 1.5S10.895 11 12 11s2 .672 2 1.5S13.105 14 12 14m0-6c2.21 0 4 1.343 4 3s-1.79 3-4 3m0-9v1m0 10v1m8-7a8 8 0 11-16 0 8 8 0 0116 0z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            d="M3 3h18M9 7v14m6-14v14M8 3v4m8-4v4M5 21h14"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      description: "See available promotions",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
    ...
    },
    {
      title: "Your QR Code",
      path: "/regular/qr",
      description: "Show your QR code at checkout",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
            d="M3 3h6v6H3zM15 3h6v6h-6zM3 15h6v6H3zM16 17v4m-2-2h4"
          />
        </svg>
      ),
  ...
  return (
    <>
      <PageMeta title="Dashboard" description="Regular user dashboard" />
